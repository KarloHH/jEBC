...
public abstract class Board {
    ...
    protected <T1, T2> void connect(QueryPin<T1, T2> out, ServicePin<T1, T2> in) {
        out.connect(in);
    }

    protected <T1, T2> ServicePin<T1, T2> join(InPin<T1> in, OutPin<T2> out) {
        return new ServiceAdapter<T1, T2>(in, out);
    }

    protected <T1, T2> QueryPin<T1, T2> extend(QueryPin<T1, T2> out) {
        return new QueryPinExtension<T1, T2>(out);
    }
    
    protected <T1, T2> ServicePin<T1, T2> extend(ServicePin<T1, T2> inChannel) {
    ...
    protected <T1, T2> void monitor(QueryPin<T1, T2> output, ServicePin<T1, T2> input, QueryMonitor<T1, T2> monitor) {
